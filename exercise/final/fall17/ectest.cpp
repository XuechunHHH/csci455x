...
void testRemoveEveryOtherUnit(string str, string exp){
...
void testRemoveEveryOther(){
   testRemoveEveryOtherUnit("3 5 7 9", "(3 7)"); 
   testRemoveEveryOtherUnit("2 7 2", "(2 2)");
   testRemoveEveryOtherUnit("12", "(12)");
   testRemoveEveryOtherUnit("10 8 6 4 2", "(10 6 2)");
   testRemoveEveryOtherUnit("", "()");
}

int main ()
{
   cout << "Start test(print \"FAILED\" once output mismatches expected ones): " << endl << endl;
   testRemoveEveryOther();
   return 0;
}
